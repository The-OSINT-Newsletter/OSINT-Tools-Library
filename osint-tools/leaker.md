---
description: >-
  Tool Description : A passive reconnaissance CLI tool that aggregates
  credential leak data from multiple breach databases, supporting searches by
  email, username, domain, keyword, and phone number.
---
...
* DeHashed
* [IntelliegenceX](intelligencex.md)

#### Sources

[https://github.com/vflame6/leaker&#x20;<br>](https://github.com/vflame6/leaker)

...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| URL              | [https://com.lullar.com/en/tools](https://com.lullar.com/en/tools)                                                           |
...
Lullar is a browser-based people-search and username-enumeration tool. You give it a username, email address, or name and it generates direct search/profile links across 170+ platforms — social media (Instagram, TikTok, X, Facebook, Reddit), messaging, gaming (Steam, Twitch, Roblox), dating, developer (GitHub), and a number of regional/non-English sites (VK, OK.ru, Weibo, Mail.ru).&#x20;

It runs entirely in the browser with no install or sign-up, and the interface is localized into 22 languages.

**The lowdown:** It's a quick, no-friction first pass for username and email reconnaissance — handy when you can't install CLI tooling or just want to map a subject's footprint in seconds, before going deeper with tools like Sherlock, Maigret, or Holehe.

### How to Use:

**1. Go to** [**https://com.lullar.com**](https://com.lullar.com/) **and enter a username, email address, or name.**&#x20;

<img src="../.gitbook/assets/unknown (247).png" alt="" height="384" width="602">

**2. Review the returned direct links per platform and open the ones relevant to your investigation.**&#x20;

<img src="../.gitbook/assets/unknown (248).png" alt="" height="364" width="602">
...
The site uses standard Google cookies: SIDCC and SSID help secure and maintain your Google account login, SOCS remembers your cookie consent preferences, and UULE helps Google provide location-based search results.
...
The tool appears in [OSINT tool lists and training resources ](https://www.aware-online.com/en/osint-tools/people-tools/)alongside other username-search tools used by researchers and investigators.&#x20;
...
| Fast pivoting between identifiers.                       | <p><br></p>                                                   |
...
[https://com.lullar.com/en/tools](https://com.lullar.com/en/tools)&#x20;

[https://www.aware-online.com/en/osint-tools/people-tools/](https://www.aware-online.com/en/osint-tools/people-tools/)&#x20;



_With thanks to saranpol for submitting this tool to the OSINT Tool Library._
